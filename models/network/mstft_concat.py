...
class MSTFT_Concat:
    """Both temporal + frequency paths but simple concatenation (no cross-attention fusion)"""
    ...
    def build(self):
        ...
        # --- Branch 2: Learnable Wavelet Transform ---
        ...
        # --- Direct Concatenation (NO Cross-Attention) ---
        ...
        fused = layers.Concatenate()([x_temporal, x_freq])
        fused = layers.Dense(self.project_dim)(
            fused
